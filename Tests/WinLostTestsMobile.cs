...
namespace HomeTest
{
    [TestFixture]
    [Category("Mobile")]
    public class WinLostTestsMobile : BaseTest
    {
        ...
        [Test]
        public async Task verifyBalanceWhenBettingSingleSpinMobile()
        {
            await _homePage.GoToProductsModule();

            var newTab = await WaitForNewTab(() => _homePage.GotoIrishWildsGameMobile());
        ...
        [Test]
        public async Task verifyBalanceWhenBettingMultiMobile()
        {
            await _homePage.GoToProductsModule();
        ...
        [Test]
        public async Task verifyBalanceWhenBettingWithIncreasedStakeMobile()
        {
            await _homePage.GoToProductsModule();
        ...
        [Test]
        public async Task verifyBalanceWhenBettingWithDecreasedStakeMobile()
        {
            await _homePage.GoToProductsModule();
        ...
        [Test]
        public async Task verifyBalanceWhenBettingTwoSpinsWithDifferentStakeMobile()
        {
            await _homePage.GoToProductsModule();
        ...
        [Test]
        public async Task verifyBalanceWhenBettingThreeSpinsWithDifferentStakeMobile()
        {
            await _homePage.GoToProductsModule();
    ...
    double previousBalance)
        ...
        public async Task<IPage> WaitForNewTab(Func<Task> actionToOpenTab)
        {
            ...
            await _homePage.GotoIrishWildsGameMobile();
